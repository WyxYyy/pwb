  ...
  <div class="RecommendDetail" v-if="listDetail != null">
    ...
    <div class="Housing">
      ...
      <ul class="HousingAbout">
        ...
        <li>
          <span>面 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 宽 :</span>
          <b>{{listDetail.house.house.surface_width}}</b>
        </li>
        <li>
          <span>房源类型 :</span>
        ...
        <li>
          <span>楼 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 层 :</span>
          <b>{{listDetail.house.house.floor}}</b>
        </li>
        <li>
          <span>付款方式 :</span>
    ...
    <footer class="flex">
      ...
      <button class="callZX" @click="loginClick('callPhone')">
        电话咨询
      </button>
  ...
  export default {
    ...
    methods: {
      ...
      loginClick(Which) {
        if (this.token == null) {
          Toast("您还未登录，立即去登录")
          window.location.href = 'http://www.puwangbao.cn/web/pc/download'
